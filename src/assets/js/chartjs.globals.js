...
Chart.defaults.global.tooltips.custom = function(model) {
  ...
  if (model.body) {
    ...
    bodyLines.forEach(function(body, i) {
      ...
      var align = bodyLines.length > 1 ? 'justify-content-left' : 'justify-content-between';

      lines += '<li class="list-group-item d-flex align-items-center ' + align + '">' + indicator + body + '</li>';
    });

    // Popover body
    html += '<div class="popover-body"><ul class="list-group list-group-flush">' + lines + '</ul></div>';
