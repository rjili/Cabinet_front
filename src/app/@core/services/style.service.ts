...
export class StyleService {
  ...
  public properties(): ColorValue[] {
    const properties = Reflect.ownKeys(this.constructor.prototype).filter(property => {
      const descriptor = Reflect.getOwnPropertyDescriptor(this.constructor.prototype, property);
  ...
  public gradient(ctx: CanvasRenderingContext2D, color: string, y: number, opacity: number) {
