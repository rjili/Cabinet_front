...
export interface LayoutVerticalConfigurationModel extends LayoutConfigurationModel {
  fixedSideNav: true;
  sidenavCollapsed: false;
}

export interface LayoutHorizontalConfigurationModel extends LayoutConfigurationModel {}
